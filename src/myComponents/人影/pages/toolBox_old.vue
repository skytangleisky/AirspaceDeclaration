...
<script lang="ts" setup>
    ...
    import { useMapStatusStore } from '~/stores/mapStatus.ts'
    import { useSysStatusStore } from '~/stores/sysStatus.ts'
    import { getMask } from '~/api/天工.ts'
    import { resetTheme } from '~/theme.ts'
    ...
    const list = reactive([{
        ...
        children: [{
            ...
            // },
            {
                label: '江西行政区划',
                type: 'folder',
                opened: modelRef(setting, '人影.监控.sichuanOptionsOpened'),
                children: [{
                    label: '填充',
                    type: 'folder',
                    ...
                    children: [{
                        label: '显示',
                        value: modelRef(setting, '人影.监控.sichuanOptions.district'),
                        type: 'checkbox'
                    }, {
                        label: '颜色',
                        value: modelRef(setting, '人影.监控.sichuanOptions.districtFillColor'),
                        type: 'color'
                    }, {
                        label: '透明度',
                    ...
                    children: [{
                        label: '显示',
                        value: modelRef(setting, '人影.监控.sichuanOptions.districtBase'),
                        type: 'checkbox'
                    }, {
                        label: '颜色',
                        value: modelRef(setting, '人影.监控.sichuanOptions.districtBaseColor'),
                        type: 'color'
                    }, {
                        label: '透明度',
                    ...
                    children: [{
                        label: '显示',
                        value: modelRef(setting, '人影.监控.sichuanOptions.districtLine'),
                        type: 'checkbox'
                    }, {
                        label: '颜色',
                        value: modelRef(setting, '人影.监控.sichuanOptions.districtLineColor'),
                        type: 'color'
                    }, {
                        label: '透明度',
            ...
            // },
            {
                ...
                children: [{
                    ...
                    label: '航路航线颜色',
                    value: modelRef(setting, '人影.监控.routeLineColor'),
                    type: 'color'
                }, {
                    label: '规划航线',
                ...
                }, // {label: '协同作业点', value: modelRef(setting, '人影.监控.synergyZyd'), type: 'checkbox'},
                    {
                        ...
                        label: '糖果图',
                        value: modelRef(setting, '人影.监控.糖果图'),
                        type: 'checkbox'
                    },]
            }, {
                label: '飞机图层',
                type: 'folder',
                children: [{
                    label: computed(() => '二次雷达信号' + sys.planeCount),
                    value: modelRef(setting, '人影.监控.plane'),
                    type: 'checkbox'
                }, ...((user.strUnitID.startsWith('99') || user.strUnitID.endsWith('0000000')) ? [{
                    label: '仅显示人影飞机',
                    value: modelRef(setting, '人影.监控.ryPlane'),
                    type: 'checkbox'
                }] : []), {
                    label: '显示航迹圈',
                    value: modelRef(setting, '人影.监控.显示航迹圈'),
                    type: 'checkbox'
                }, {
                    label: '速度矢量线',
                    value: modelRef(setting, '人影.监控.速度矢量线'),
                    type: 'checkbox'
                }, {
                    label: 'ADS-B信号',
                ...
                children: [{
                    label: '在线人数',
                    value: modelRef(sys, '在线人数'),
                    type: 'text'
                }, {
                    label: '网络状态',
                    value: modelRef(sys, '网络状态'),
                    type: 'text'
                }, {
                    label: '内存占用',
                    value: modelRef(sys, '内存占用'),
                    type: 'text'
                }, {
                    label: '当前经度',
