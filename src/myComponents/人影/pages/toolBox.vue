...
<script lang="ts" setup>
    ...
    const list = reactive([{
        label: '开发工具',
        type: 'folder',
        opened: modelRef(setting, 'devtoolsOpen'),
        children: [{
            label: '主题',
            value: theme,
            type: 'select',
            ...
            label: '准心',
            value: modelRef(setting, '人影.监控.准心'),
            type: 'checkbox'
        }, {
            label: '菜单',
            value: modelRef(setting, 'menus'),
            type: 'checkbox'
        }, // {label:'色相',value:toRefs(setting).hueRotate,type:'range',min:0,max:360,step:1,arr:Array.from({length:361},(_,i:number)=>i)},
            {
                label: '地面颜色',
                value: modelRef(setting, '人影.监控.landColor'),
                type: 'color'
            }, {
                label: '全国行政区划',
                type: 'folder',
                opened: modelRef(setting, '人影.监控.districtOptionsOpened'),
                children: [{
                    label: '填充',
                    type: 'folder',
                    ...
                    children: [{
                        label: '显示',
                        value: modelRef(setting, '人影.监控.districtOptions.district'),
                        type: 'checkbox'
                    }, {
                        label: '颜色',
                        value: modelRef(setting, '人影.监控.districtOptions.districtFillColor'),
                        type: 'color'
                    }, {
                        label: '透明度',
                    ...
                    children: [{
                        label: '显示',
                        value: modelRef(setting, '人影.监控.districtOptions.districtBase'),
                        type: 'checkbox'
                    }, {
                        label: '颜色',
                        value: modelRef(setting, '人影.监控.districtOptions.districtBaseColor'),
                        type: 'color'
                    }, {
                        label: '透明度',
                    ...
                    children: [{
                        label: '显示',
                        value: modelRef(setting, '人影.监控.districtOptions.districtLine'),
                        type: 'checkbox'
                    }, {
                        label: '颜色',
                        value: modelRef(setting, '人影.监控.districtOptions.districtLineColor'),
                        type: 'color'
                    }, {
                        label: '透明度',
                ...
                label: '北京行政区划',
                type: 'folder',
                opened: modelRef(setting, '人影.监控.beijingOptionsOpened'),
                children: [{
                    label: '填充',
                    type: 'folder',
                    ...
                    children: [{
                        label: '显示',
                        value: modelRef(setting, '人影.监控.beijingOptions.district'),
                        type: 'checkbox'
                    }, {
                        label: '颜色',
                        value: modelRef(setting, '人影.监控.beijingOptions.districtFillColor'),
                        type: 'color'
                    }, {
                        label: '透明度',
                    ...
                    children: [{
                        label: '显示',
                        value: modelRef(setting, '人影.监控.beijingOptions.districtBase'),
                        type: 'checkbox'
                    }, {
                        label: '颜色',
                        value: modelRef(setting, '人影.监控.beijingOptions.districtBaseColor'),
                        type: 'color'
                    }, {
                        label: '透明度',
                    ...
                    children: [{
                        label: '显示',
                        value: modelRef(setting, '人影.监控.beijingOptions.districtLine'),
                        type: 'checkbox'
                    }, {
                        label: '颜色',
                        value: modelRef(setting, '人影.监控.beijingOptions.districtLineColor'),
                        type: 'color'
                    }, {
                        label: '透明度',
                ...
                label: '华北飞行区域',
                type: 'folder',
                opened: modelRef(setting, '人影.监控.ryAirspacesOpened'),
                children: [{
                    label: '填充',
                    type: 'folder',
                    opened: modelRef(setting, '人影.监控.ryAirspaces.fillOpened'),
                    children: [{
                        label: '显示',
                        value: modelRef(setting, '人影.监控.ryAirspaces.fill'),
                        type: 'checkbox'
                    }, {
                        label: '颜色',
                        value: modelRef(setting, '人影.监控.ryAirspaces.fillColor'),
                        type: 'color'
                    }, {
                        label: '透明度',
                    ...
                    label: '底线',
                    type: 'folder',
                    opened: modelRef(setting, '人影.监控.ryAirspaces.baseOpened'),
                    children: [{
                        label: '显示',
                        value: modelRef(setting, '人影.监控.ryAirspaces.base'),
                        type: 'checkbox'
                    }, {
                        label: '颜色',
                        value: modelRef(setting, '人影.监控.ryAirspaces.baseColor'),
                        type: 'color'
                    }, {
                        label: '透明度',
                    ...
                    label: '界线',
                    type: 'folder',
                    opened: modelRef(setting, '人影.监控.ryAirspaces.lineOpened'),
                    children: [{
                        label: '显示',
                        value: modelRef(setting, '人影.监控.ryAirspaces.line'),
                        type: 'checkbox'
                    }, {
                        label: '颜色',
                        value: modelRef(setting, '人影.监控.ryAirspaces.lineColor'),
                        type: 'color'
                    }, {
                        label: '透明度',
                    ...
                    label: '标签',
                    type: 'folder',
                    opened: modelRef(setting, '人影.监控.ryAirspaces.labelOpened'),
                    children: [{
                        label: '显示',
                        value: modelRef(setting, '人影.监控.ryAirspaces.label'),
                        type: 'checkbox'
                    }, {
                        label: '颜色',
                        value: modelRef(setting, '人影.监控.ryAirspaces.labelColor'),
                        type: 'color'
                    }, {
                        label: '透明度',
                ...
                label: '经度',
                value: computed(() => setting.人影.监控.经度.toFixed(6)),
                type: 'text'
            }, {
                label: '维度',
                value: computed(() => setting.人影.监控.纬度.toFixed(6)),
                type: 'text'
            }, {
                label: '位置',
                value: computed(() => {
                ...
                label: '系统信息',
                type: 'folder',
                opened: modelRef(setting, '人影.监控.systemInfoOpened'),
                children: [{
                    label: '在线人数',
                    value: modelRef(setting, '在线人数'),
                    type: 'text'
                }, {
                    label: '网络状态',
                    value: modelRef(setting, '网络状态'),
                    type: 'text'
                }, {
                    label: '内存占用',
                    value: modelRef(setting, '内存占用'),
                    type: 'text'
                }, {
                    label: '中心经度',
                    value: computed(() => mapStatus.center[0].toFixed(6)),
                    type: 'text'
                }, {
                    label: '中心纬度',
                    value: computed(() => mapStatus.center[1].toFixed(6)),
                    type: 'text'
                }, {
                    label: '缩放等级',
                    value: computed(() => mapStatus.zoom.toFixed(6)),
                    type: 'text'
                }, {
                    label: '帧率',
