<template>
  <div class="tool-btns">
    <div class="btn-box"><div class="distributionClass"></div></div>
    <div class="btn-box" @click="toolkitButtonClick"><div class="productsClass"></div></div>
    <div class="btn-box"><div class="toolClass"></div></div>
    <div class="btn-box"><div class="favoritesClass"></div></div>
  </div>
