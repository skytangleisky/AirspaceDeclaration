export function 紧急力量规划航迹(map,规划航线数据,setting,wgs84togcj02){
  ...
  // 填充多边形
  map.addLayer({
    'id': 'three_polygon-fill',
    'type': 'fill',
    'source': 'three_polygons',
    'layout': {
  ...
  map.getSource('three_polygons').setData(polygonsFeatues)
